...
export default function PortfolioBackground() {
  ...
  return (
    // The main container needs to be tall enough to allow scrolling
    <div className="relative w-full h-[300vh] bg-[#f8f9fa] overflow-hidden font-sans">
      
      {/* FIXED BACKGROUND LAYER 
        This stays locked in place while the user scrolls the page.
      */}
      <div className="fixed inset-0 pointer-events-none flex items-center justify-center">
        ...
        >
          {/* FADE MASK 
            This CSS trick fades the edges of the drawing into the background color.
          */}
          <div 
          ...
          >
            {/* YOUR IMAGE GOES HERE!
              Uncomment the img tag below and delete the SVG to use your actual drawings.
              I added a CSS filter to turn the black linework into a nice light steel blue/gray.*/
            ...
            */}
            ...
            {/* Placeholder CAD SVG just so the preview looks awesome immediately */}
      ...
      {/* FOREGROUND CONTENT 
        Just some dummy content so you can actually scroll the page and test the animation.
      */}
      <div className="relative z-10 flex flex-col items-center pt-[30vh] gap-[80vh] px-4 text-center">
        <div className="max-w-2xl bg-white/50 backdrop-blur-sm p-8 rounded-2xl shadow-sm border border-slate-100">
          <h1 className="text-5xl font-bold tracking-tight text-slate-800 drop-shadow-sm mb-4">
            Mechanical Design Portfolio
          </h1>
          <p className="text-lg text-slate-500">
            Scroll down to see the CAD background animate and fade out.
          </p>
        </div>
        
        <div className="max-w-2xl bg-white/50 backdrop-blur-sm p-8 rounded-2xl shadow-sm border border-slate-100">
          <h2 className="text-3xl font-semibold text-slate-700">Project Highlights</h2>
          <p className="text-slate-500 mt-2">Notice how the drawing is scaling towards you and fading away?</p>
        </div>

        <div className="max-w-2xl bg-white/50 backdrop-blur-sm p-8 rounded-2xl shadow-sm border border-slate-100 mb-[20vh]">
          <h2 className="text-3xl font-semibold text-slate-700">Experience</h2>
          <p className="text-slate-500 mt-2">By this point, the background is completely gone.</p>
        </div>
      </div>
