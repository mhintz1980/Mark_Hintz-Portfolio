...
const portfolioData = {
  ...
  // HERO ACTIONS
  heroActions: [
    { label: "View resume", href: "assets/images/Mark_Hintz-Mechanical_Designer-1.webp", target: "_blank" },
  ...
  // FIXED CTA BUTTONS
  ctaButtons: [
    { label: "View resume", href: "assets/images/js_image_29.png", primary: true },
